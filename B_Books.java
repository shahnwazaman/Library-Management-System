...
public class B_Books {
    ...
    // Class data members
    A_Book theBooks[] = new A_Book[50];
    public static int count;

    Scanner input = new Scanner(System.in);

    // Method 1 To compare books
    public int compareBookObjects(A_Book b1, A_Book b2)
    {
    ...
    public void checkInBook(A_Book b)
    {
        for (int i = 0; i < count; i++) {
